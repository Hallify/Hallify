<?php
     ...
     * @package Hallify\Controllers\Settings
     * @version 1.0
     **/


    class Settings extends \Hallify\Core\Controller
    {
        use \Hallify\Traits\PageStructure;
        ...
        /**
         * Page : index (settings page main view)
         **/
        public function index()
        {
            ...
            // load the view
            $this->displayView("settings/index.php");
